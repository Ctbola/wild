...
<head>
  <meta charset="utf-8" />
  <title>HusmaBreath - About Us</title>
...
<body>
  ...
  <div id="spinner"
    ...
    <div class="spinner-border text-primary" style="width: 3rem; height: 3rem" role="status">
      <span class="sr-only">Loading.1222.</span>
    </div>
  </div>
  <!-- Spinner End -->
      ...
      <div class="row g-5 justify-content-center">
        <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <p class="mb-4 text-center fw-bold">
            Let's secure elephants as well as precious human lives for the future through a permanent-long-term solution
            to the human-elephant problem.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row g-5 justify-content-center">
        <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <p class="mb-4 text-center fw-bold">
            Let us unite for the duty of preserving and protecting the elephants,
            which are a national resource, for future generations through a national policy.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
        <div class="testimonial-item text-center">
          <img class="img-fluid rounded-circle border border-2 p-2 mx-auto mb-4" src="img/yu7tu.jpg"
            style="width: 100px; height: 100px" />
          <div class="testimonial-text rounded text-center p-4">
            <p>
              Sri Lanka's Elephant is a national resource and through proper management of that resource, it can be
              converted into foreign exchange.
              <br/><br/>
              "In short , an Elephant's is a machine that print foreign Exchange"

            </p>
            <h5 class="mb-1">K. K. M. De Silva</h5>
            <span class="fst-italic">President - BREATH Organization</span>
          </div>
        </div>
        <!-- <div class="testimonial-item text-center">
