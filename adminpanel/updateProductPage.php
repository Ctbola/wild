...
if (isset($_SESSION["u"])) {
    ...
    $pid = $_GET["id"];
    $Update_rs = Database::search("SELECT * FROM `product` WHERE `id` = '" . $pid . "'");
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="productTitle"
                                            value="<?php echo $Update_data["name"] ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Product Description</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" style="height: 100px" id="productDescription"
                                            value="<?php echo $Update_data["description"] ?>">
                                    </div>
                                </div>
                                <!-- <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="productPrice"
                                            value="<?php echo $Update_data["price"] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12 text-center">
                                        <button type="button" class="btn btn-success rounded-pill"
                                            onclick="updateProduct(<?php echo $pid ?>);">Update Product</button>
                                    </div>
                                </div>
