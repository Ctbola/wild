        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h2><?php echo($_SESSION['u']['name'])?></h2>
              <h3>Admin</h3>
            </div>
          </div>
              ...
              <div class="tab-content pt-2">
                ...
                <form>
                    ...
                    <div class="text-center">
                      <button type="button" class="btn btn-success rounded-pill" onclick="changepassword();">Change Password</button>
                ...
                <div class="d-none tab-pane fade profile-edit pt-3" id="profile-edit">
