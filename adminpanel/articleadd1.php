                  ...
                  <form>
                    <div class="form-group">
                      ...
                      <div class="d-flex flex-column mb-1">
                        ...
                        <input id="articleTitle" type="text" class="w-100 p-2">
                      </div>

                      <label for="updateArticleDescription" class="d-flex flex-column mb-2">Article Description</label>
                      <label>Paragraph 1:</label>
                      <input type="text" id="para1" style="width: 633px; height: 100px;">
                    ...
                    <button onclick="addNewArticle2();" type="button" class="btn btn-success rounded-pill mt-2">Upload
                    ...
                    <button id="submitBtn" type="button" class="btn btn-success rounded-pill">Upload
                      Article</button>
